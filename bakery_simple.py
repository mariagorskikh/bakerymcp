...
app = FastAPI(title="Simple Bakery API", description="Simple bakery availability checker")
...
async def root():
    ...
    return {"message": "Simple Bakery API is running. Use /check endpoint to check item availability."}
